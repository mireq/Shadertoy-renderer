...
class VideoRenderPass(BaseRenderPass):
	...
	def __init__(self, renderer):
		...
		if self.renderer.options.render_video_hdr:
			...
			#replacements['hdr_args'] = ['-vf', 'colorspace=bt2020:ispace=bt2020nc:space=bt2020nc:itrc=linear:trc=linear:iprimaries=smpte431:primaries=bt2020:irange=tv:range=tv', '-color_range', 'tv', '-color_trc', 'arib-std-b67', '-color_primaries', 'bt2020', '-colorspace', 'bt2020nc', '-x265-params', 'colorprim=bt2020:transfer=arib-std-b67:colormatrix=bt2020nc:range=limited:master-display=G(13250,34500)B(7500,3000)R(34000,16000)WP(15635,16450)L(10000000,1):max-cll=1000']
			#replacements['hdr_args'] = ['-vf', 'colorspace=bt2020:ispace=bt2020nc:space=bt2020nc:itrc=linear:trc=bt2020-12:iprimaries=smpte431:primaries=bt2020:irange=tv:range=tv', '-color_range', 'tv', '-color_trc', 'arib-std-b67', '-color_primaries', 'bt2020', '-colorspace', 'bt2020nc', '-x265-params', 'colorprim=bt2020:transfer=arib-std-b67:colormatrix=bt2020nc:range=limited:master-display=G(13250,34500)B(7500,3000)R(34000,16000)WP(15635,16450)L(10000000,1):max-cll=1000']
			#replacements['hdr_args'] = ['-vf', 'zscale=npl=1000:rin=limited:r=limited:tin=linear:t=linear:pin=2020:min=709:m=2020_ncl:p=2020,format=yuv420p10le', '-color_range', 'tv', '-color_trc', 'arib-std-b67', '-color_primaries', 'bt2020', '-colorspace', 'bt2020nc', '-x265-params', 'hdr-opt=1:repeat-headers=1:colorprim=bt2020:transfer=arib-std-b67:colormatrix=bt2020nc:range=limited:master-display=G(13250,34500)B(7500,3000)R(34000,16000)WP(15635,16450)L(10000000,1):max-cll=1000']
			#replacements['hdr_args'] = ['-vf', 'zscale=npl=1000:rin=limited:r=limited:tin=input:t=input:pin=2020:min=709:m=2020_ncl:p=2020,format=yuv420p10le', '-color_range', 'tv', '-color_trc', 'arib-std-b67', '-color_primaries', 'bt2020', '-colorspace', 'bt2020nc', '-x265-params', 'hdr-opt=1:repeat-headers=1:colorprim=bt2020:transfer=arib-std-b67:colormatrix=bt2020nc:range=limited:master-display=G(13250,34500)B(7500,3000)R(34000,16000)WP(15635,16450)L(10000000,1):max-cll=1000']
			replacements['hdr_args'] = ['-vf', 'colorspace=bt2020:ispace=bt2020nc:space=bt2020nc:itrc=linear:trc=linear:iprimaries=bt2020:primaries=bt2020:irange=tv:range=tv', '-color_range', 'tv', '-color_trc', 'arib-std-b67', '-color_primaries', 'bt2020', '-colorspace', 'bt2020nc', '-x265-params', 'repeat-headers=1:colorprim=bt2020:transfer=arib-std-b67:colormatrix=bt2020nc:range=limited:master-display=G(13250,34500)B(7500,3000)R(34000,16000)WP(15635,16450)L(10000000,1):max-cll=1000']
